...
public class FilmesMap {
    ...
    public static void initFilme() {
        ...
        filme.put("descricao", "Um alerta vermelho da Interpol é emitido e o agenda do FBI John Hartley " +
                "assume o caso. Durante sua busca, ele vê diante de um assalto ousado e é forçado a se " +
